// Generado por odoo2rs — vista form de account.account.tag (account_tag_view_form).
// NO EDITAR A MANO; regenerar con `odoo2rs gen-js`.

import { renderFormPage } from '../components/form_view.js'

export const DESCRIPTOR = {
  "xml_id": "account_tag_view_form",
  "name": "Tags",
...
export function renderAccountAccountTagForm(record = {}) {
  renderFormPage({
    breadcrumb: [{ label: 'account.account.tag' }],
    ...
    statusButtons: DESCRIPTOR.buttons?.map(b => ({
      ...
      // TODO(odoo2rs): conectar a /api/v1/orm/account.account.tag/<método> (≈ call_kw)
